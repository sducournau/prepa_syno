...
class PrepaSyno:
    ...
    def __init__(self, iface):
        ...
        self.actions = []
        self.menu = self.tr(u'&Préparation des données pour le synoptique')
        # TODO: We are going to let the user set this up in a future iteration
        self.toolbar = self.iface.addToolBar(u'PrepaSyno')
        self.toolbar.setObjectName(u'PrepaSyno')

        #print "** INITIALIZING PrepaSyno"
    ...
    def tr(self, message):
        ...
        return QCoreApplication.translate('PrepaSyno', message)
    ...
    def initGui(self):
        ...
        icon_path = ':/plugins/prepa_syno/icon.png'
        self.add_action(
            icon_path,
            text=self.tr(u'Préparation pour le synoptique'),
            callback=self.run,
    ...
    def unload(self):
        ...
        #print "** UNLOAD PrepaSyno"

        for action in self.actions:
            self.iface.removePluginMenu(
                self.tr(u'&Préparation des données pour le synoptique'),
                action)
